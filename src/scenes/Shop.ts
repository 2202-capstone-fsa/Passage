...
export default class Shop extends Phaser.Scene {
  ...
  create() {
    ...
    const wallsLayer = map.createLayer('walls', [crafthouseTileSet,decorationsTileSet,propsTileSet]);
    const decoreLayer = map.createLayer('decore', [crafthouseTileSet,decorationsTileSet,propsTileSet]);
    const decorationsLayer = map.createLayer('decorations', [decorationsTileSet,propsTileSet]);
    ...
    this.physics.add.collider(this.player, [wallsLayer,decoreLayer,decorationsLayer]);
